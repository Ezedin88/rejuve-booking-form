...
const CustomInput = ({ label, placeholder, cityStateZip,dateOfBirth, ...props }) => {
    ...
    return (
        <>
            ...
            {(props.type !== 'radio' && props.type !== 'textArea' && props.type !== 'date' && props.type !== 'time') && (
                <div className={cityStateZip ? 'cityStateZip' : 'input-box-wrapper'}>
                    <div className="label-input-wrapper">
                        ...
                        <input placeholder={placeholder} {...field} {...props} autoComplete="true" className={props.name === 'bookingAddress.address_1' ? 'input-box' : 'input-box'} />
                    </div>
