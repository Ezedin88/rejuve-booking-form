...
/>
      ...
      <div>
        <div className='agreement-wrapper-label'>
          ...
          <input
          className='agreement-checkbox-input'
          type="checkbox" name="createAccount" id="createAccount" value="createAccount" checked={agreeToCreateAccount} onChange={() => setAgreeToCreateAccount(!agreeToCreateAccount)} />
         <p className='agreement-description'> Create an account for me and send me secure login details to my e-mail. (recommended)
         </p>
        </div>
      </div>
      <div>
        <div className='agreement-wrapper-label'>
          ...
          <input
          className='agreement-checkbox-input'
          type="checkbox" name="signUp" id="signUp" value="signUp" checked={agreeToSignUp} onChange={() => setAgreeToSignUp(!agreeToSignUp)} />
          <p className='agreement-description'>Sign-up to receiving exclusive offers and service updates! (recommended)
          </p>
        </div>
      </div>
    </div>
