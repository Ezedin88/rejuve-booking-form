...
function ProductHero({ currentProduct, setProductPrice, setWhereBooking, isFetchingProduct, values, lineItems, setLineItems, treatmentChoices, selectNad, setCurrentProduct }) {
                ...
                <section className="product-hero-wrapper">
                    ...
                    <section className="product-description-wrapper">
                        ...
                        <div className="product-price-buttons-wrapper">
                            {!isCurrentNadType && <div className="booking-buttons">
                                        ...
                                        {selectNad.map((item, index) => {
                                            return (
                                                <div className="booking-buttons" key={index}>
                                                    <button className="book-button nad-buttons"
