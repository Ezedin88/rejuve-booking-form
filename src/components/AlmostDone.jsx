        ...
        <div className="promo-wrapper">
          {/* <div className="promo-and-gift">
            ...
            <div className="promo-checkbox-and-label">
              <Field
                className="promo-check-box"
                id="giftCard"
                type="checkbox"
                name="giftCard"
              />
              <label htmlFor="giftCard" className="gift-card-label">
                Gift Card
              </label>
            </div>
            <div className="promo-discount-button-wrapper">
              <input
                className="enter-promo-discount"
          ...
          <div className="inner-tip-wrapper">
            ...
            <div className="tips-and-inbox">
              <div className="flex-tips-wrapper">
                {[5, 10, 15, 20].map((percentage) => (
                  <div className="tip-choice-group" key={percentage}>
                    ...
                    />
                    <label htmlFor={`${Number(percentage)}%`}>{`${Number(
                      percentage
                    )}%`}</label>
                  </div>
                ))}
              ...
              <div className="flex-tips-wrapper">
                <div className="tip-choice-group" key="others">
                  <input
                    className="tip-radio"
                    type="radio"
            ...
            <div className="tip-input-and-dollar-wrapper">
              <input
                ...
                id="tip-input"
                className="tip-input input-box"
                style={{ marginTop: '30px' }}
                onChange={handleCustomTipChange}
              />
            </div>
            <div
              className="total-tip-wrapper"
              style={{ display: 'flex', gap: 10 }}
            >
              <p className="tipTotalLabel">
                Tip total:
